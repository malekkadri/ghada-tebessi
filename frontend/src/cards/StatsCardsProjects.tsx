...
import { FaFolder, FaFolderOpen, FaFolderMinus, FaBan, FaFolderPlus } from 'react-icons/fa';
...
const StatsCardsProjects: React.FC<StatsCardsProps> = ({ stats }) => (
  <div className="grid gap-6 mb-8 md:grid-cols-3 xl:grid-cols-5">
    ...
    />
    <StatCard 
      icon={<FaFolderMinus className="w-5 h-5" />}
      title="Archived"
...
export default StatsCardsProjects;